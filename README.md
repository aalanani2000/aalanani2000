...
| Project | What it is |
|---|---|
| 🌐 **[anani.online](https://anani.online)** | This portfolio — a working RAG system: TF-IDF retrieval, DeepSeek streaming, cited answers, AR/EN |
| 🔁 **[al-rouf-ai-integration-assessment](https://github.com/aalanani2000/al-rouf-ai-integration-assessment)** | RFQ→CRM automation (n8n + OpenAI) · FastAPI quotation service · bilingual RAG with refusal logic |
| 🧠 **[llm-engineering-journey](https://github.com/aalanani2000/llm-engineering-journey)** | Hands-on LLM engineering: structured JSON outputs, dual-backend streaming (OpenAI + Ollama) |
| 📊 **[ml-internship-project](https://github.com/aalanani2000/ml-internship-project)** | 4 classical ML tasks with verified metrics (R² 0.66 · Acc 0.80/0.95 · ROC AUC 0.886) + trained artifacts |
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/aalanani2000/aalanani2000/output/github-snake-dark.svg" />
  <img src="https://raw.githubusercontent.com/aalanani2000/aalanani2000/output/github-snake.svg" alt="snake" />
</picture>
